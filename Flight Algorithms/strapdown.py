...
def strapdown(r_ecef, v_ecef, q_e2b, imu_accel, imu_gyro, dt):
    ...
    Notes:
        The IMU often fails on getting a good read, and it returns None in those cases
        When this happens, quaternion or velocity do not update
    ...
    # Attitude Update -- if the IMU returns an acceleration
